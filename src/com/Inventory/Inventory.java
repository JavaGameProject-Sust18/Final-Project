...
public class Inventory {
    ...
    invListCenterX=invX+171,invListCenterY=invY+invHeight/2+5,invListSpacing = 28;;
        ...
        for(int i = -5;i < 6;i++){
            ...
            if(i == 0){
                Text.drawString(g, "> " + inventoryItems.get(selectedItem + i).getName() + " <", invListCenterX,
                        invListCenterY + i * invListSpacing, true, Color.YELLOW,  new Font("Arial", Font.PLAIN, 25));
            }else{
                Text.drawString(g, inventoryItems.get(selectedItem + i).getName(), invListCenterX,
                        invListCenterY + i * invListSpacing, true, Color.WHITE, new Font("Arial", Font.PLAIN, 25));
            }
        }
