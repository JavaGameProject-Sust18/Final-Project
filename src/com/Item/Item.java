...
public class Item {
    ...
    public static Item stone=new Item(Assets.coin,"Topus",3,50,50);
    public static Item stone1=new Item(Assets.coin_1,"Oppo",4,50,50);
    ...
    public static Item stone2=new Item(Assets.coin_2,"Diamond",11,50,50);
    public static Item stone3=new Item(Assets.coin_3,"Ruby",20,50,50);
